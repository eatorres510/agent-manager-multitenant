    ...
    <div className="glass-card" style={{ animation: 'fadeIn 0.2s ease-out' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h2 className="card-title" style={{ color: '#0b2b4c', margin: 0, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <span className="material-symbols-outlined" style={{ color: '#2563eb', fontSize: '1.6rem' }}>contacts</span>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          ...
          <button
            ...
            style={{ backgroundColor: '#2563eb', display: 'flex', alignItems: 'center', gap: '0.4rem' }}
          >
          ...
          <tbody>
            {loading ? (
              ...
              filteredContacts.map((c) => {
                ...
                return (
                  <tr key={c.id} style={{ borderBottom: '1px solid #f1f5f9', backgroundColor: isSelected ? '#eff6ff' : 'transparent', transition: 'background-color 0.15s' }}>
                    ...
                    <td style={{ padding: '0.85rem 1rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
                        ...
                        <div>
                          <div style={{ fontWeight: 800, color: '#0b2b4c' }}>{c.name || 'Contacto sin nombre'}</div>
                          <div style={{ fontSize: '0.72rem', color: '#94a3b8', fontFamily: 'monospace' }}>ID: #{c.id}</div>
                        </div>
                      </div>
                    </td>

                    <td style={{ padding: '0.85rem 1rem', fontFamily: 'monospace', fontWeight: 600, color: '#2563eb' }}>
                      {c.phone_number ? `📱 ${c.phone_number}` : <span style={{ color: '#94a3b8', fontStyle: 'italic' }}>Sin teléfono</span>}
                    </td>

                    <td style={{ padding: '0.85rem 1rem', color: '#475569' }}>
                      {c.email || <span style={{ color: '#94a3b8', fontStyle: 'italic' }}>Sin correo</span>}
                    </td>
                    ...
                    <td style={{ padding: '0.85rem 1rem' }}>
                      <span style={{
                        ...
                        borderRadius: '12px',
                        fontWeight: 800,
                        backgroundColor: leadScore === 'Caliente' ? '#fef2f2' : leadScore === 'Tibio' ? '#fffbebf' : '#f1f5f9',
                        color: leadScore === 'Caliente' ? '#ef4444' : leadScore === 'Tibio' ? '#d97706' : '#64748b',
                        border: `1px solid ${leadScore === 'Caliente' ? '#fca5a5' : leadScore === 'Tibio' ? '#fcd34d' : '#cbd5e1'}`
                      }}>
                    ...
                    <td style={{ padding: '0.85rem 1rem' }}>
                      {empresa ? (
                        ...
                        >
                          <span>🏢 {empresa}</span>
                          {ruc && <span style={{ fontSize: '0.7rem', color: '#64748b', fontFamily: 'monospace' }}>RUC: {ruc}</span>}
                        </div>
                      ) : (
                        <span style={{ color: '#94a3b8', fontStyle: 'italic' }}>Sin empresa</span>
                      )}
                    </td>

                    {/* Última Actividad */}
                    <td style={{ padding: '0.85rem 1rem', fontSize: '0.8rem', fontWeight: 600, color: '#475569', whiteSpace: 'nowrap' }}>
                    ...
                    <td style={{ padding: '0.85rem 1rem' }}>
                      <div style={{ display: 'flex', gap: '0.3rem', flexWrap: 'wrap' }}>
                        {labelsList.length > 0 ? (
                          ...
                          <span style={{ fontSize: '0.72rem', color: '#94a3b8', fontStyle: 'italic' }}>Sin etiquetas</span>
                        )}
                      </div>
                    </td>
                    ...
                    <td style={{ padding: '0.85rem 1rem', textAlign: 'center' }}>
                      <div style={{ display: 'flex', gap: '0.35rem', justifyContent: 'center' }}>
                        <button
                          onClick={() => onOpenChat()}
                          title="Abrir Chat"
                          style={{ padding: '0.3rem 0.6rem', borderRadius: '6px', border: 'none', backgroundColor: '#2563eb', color: '#ffffff', fontWeight: 700, fontSize: '0.75rem', cursor: 'pointer' }}
                        >
                          💬
                        </button>
                        ...
                        {role !== 'readonly' && (
                          <button
                            ...
                            style={{ padding: '0.3rem 0.6rem', borderRadius: '6px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', color: '#0b2b4c', fontWeight: 700, fontSize: '0.75rem', cursor: 'pointer' }}
                          >
                            ✏️
                          </button>
                        )}
                        ...
                        {onOpenOpportunityModal && (
                          <button
                            ...
                            style={{ padding: '0.3rem 0.6rem', borderRadius: '6px', border: '1px solid #a7f3d0', backgroundColor: '#ecfdf5', color: '#059669', fontWeight: 700, fontSize: '0.75rem', cursor: 'pointer' }}
                          >
                            ➕ CRM
                          </button>
                        )}
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: '1px solid #cbd5e1',
              backgroundColor: (filteredContacts.length < 15 && totalCount <= page * 15) ? '#f1f5f9' : '#ffffff',
              color: (filteredContacts.length < 15 && totalCount <= page * 15) ? '#94a3b8' : '#0b2b4c',
              fontWeight: 700,
              fontSize: '0.78rem',
      ...
      {showSaveListModal && (
        <div style={{
          ...
          <div style={{ backgroundColor: '#ffffff', padding: '1.5rem', borderRadius: '14px', width: '100%', maxWidth: '450px', boxShadow: '0 20px 40px rgba(0,0,0,0.25)' }}>
            <h3 style={{ margin: '0 0 0.5rem 0', color: '#0b2b4c', fontSize: '1.1rem', fontWeight: 800 }}>
            ...
            <form onSubmit={handleSaveList} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div className="form-group">
                <label style={{ fontWeight: 800, fontSize: '0.82rem', color: '#0b2b4c' }}>Nombre de la Lista</label>
                <input
                  type="text"
                  value={newListName}
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem', marginTop: '0.5rem' }}>
                <button
                  ...
                  style={{ padding: '0.55rem 1rem', borderRadius: '6px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', color: '#475569', fontWeight: 700, fontSize: '0.82rem', cursor: 'pointer' }}
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={savingList}
                  style={{ padding: '0.55rem 1.25rem', borderRadius: '6px', border: 'none', backgroundColor: '#10b981', color: '#ffffff', fontWeight: 800, fontSize: '0.82rem', cursor: 'pointer' }}
                >
      ...
      {editingContact && (
        <div style={{
          ...
          <div className="glass-card" style={{
            ...
            <div style={{ backgroundColor: '#0b2b4c', padding: '1.25rem 1.5rem', color: '#ffffff', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800 }}>✏️ Editar Contacto, Empresa & Etiquetas</h3>
                <p style={{ margin: '0.15rem 0 0 0', fontSize: '0.78rem', color: '#93c5fd' }}>Sincronizado con Chatwoot y PostgreSQL (ID: #{editingContact.id})</p>
              </div>
              <button onClick={() => setEditingContact(null)} style={{ border: 'none', background: 'none', color: '#94a3b8', fontSize: '1.2rem', cursor: 'pointer' }}>✕</button>
            </div>
            ...
            <form onSubmit={handleSaveContact} style={{ padding: '1.5rem', overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem' }}>
                <div className="form-group">
                  <label style={{ fontWeight: 800, fontSize: '0.82rem', color: '#0b2b4c' }}>Nombre del Contacto</label>
                  <input type="text" value={editName} onChange={(e) => setEditName(e.target.value)} required style={{ width: '100%', padding: '0.6rem', borderRadius: '6px', border: '1px solid #cbd5e1' }} />
                </div>
                <div className="form-group">
                  <label style={{ fontWeight: 800, fontSize: '0.82rem', color: '#0b2b4c' }}>Teléfono WhatsApp</label>
                  <input type="text" value={editPhone} onChange={(e) => setEditPhone(e.target.value)} placeholder="+50588885707" style={{ width: '100%', padding: '0.6rem', borderRadius: '6px', border: '1px solid #cbd5e1', fontFamily: 'monospace' }} />
                </div>
              </div>

              <div className="form-group">
                <label style={{ fontWeight: 800, fontSize: '0.82rem', color: '#0b2b4c' }}>Correo Electrónico</label>
                <input type="email" value={editEmail} onChange={(e) => setEditEmail(e.target.value)} placeholder="ej. cliente@empresa.com" style={{ width: '100%', padding: '0.6rem', borderRadius: '6px', border: '1px solid #cbd5e1' }} />
              </div>

              {/* CONTACT LABELS (ETIQUETAS) SECTION */}
              <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '1rem' }}>
                <h4 style={{ margin: '0 0 0.6rem 0', color: '#6d28d9', fontSize: '0.92rem', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap', marginBottom: '0.75rem' }}>
                  ...
                  {contactLabels.length === 0 && (
                    <span style={{ fontSize: '0.8rem', color: '#94a3b8', fontStyle: 'italic' }}>Sin etiquetas asignadas.</span>
                  )}
                </div>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                  <input
                    ...
                    style={{ flex: 1, padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.82rem' }}
                  />
                  <button
                    type="button"
                    onClick={() => handleAddLabel(newLabelInput)}
                    style={{ padding: '0.5rem 0.85rem', borderRadius: '6px', border: 'none', backgroundColor: '#7c3aed', color: '#ffffff', fontWeight: 800, fontSize: '0.78rem', cursor: 'pointer' }}
                  >
                    + Añadir Etiqueta
                  </button>
                </div>
                ...
                {tenantLabels.length > 0 && (
                  <div style={{ marginTop: '0.5rem', display: 'flex', gap: '0.3rem', flexWrap: 'wrap', alignItems: 'center' }}>
                    <span style={{ fontSize: '0.72rem', color: '#64748b' }}>Sugeridos:</span>
                    {tenantLabels.slice(0, 6).map((tl, i) => (
                      <button
                        key={i}
                        type="button"
                        onClick={() => handleAddLabel(tl.title)}
                        style={{ padding: '0.15rem 0.45rem', fontSize: '0.7rem', borderRadius: '4px', border: '1px solid #e2e8f0', backgroundColor: '#ffffff', color: '#475569', cursor: 'pointer' }}
                      >
                        + {tl.title}
                      </button>
                    ))}
              ...
              <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '1rem' }}>
                <h4 style={{ margin: '0 0 0.85rem 0', color: '#2563eb', fontSize: '0.92rem', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                  ...
                  {customFields.map((field, idx) => {
                    ...
                    return (
                      <div key={idx} style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                        <div style={{ width: '35%', fontWeight: 700, fontSize: '0.8rem', color: '#475569', backgroundColor: '#f8fafc', padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
                        ...
                        {isLeadScore ? (
                          <select
                            ...
                            style={{ flex: 1, padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.82rem', fontWeight: 800, color: field.value === 'Caliente' ? '#ef4444' : field.value === 'Tibio' ? '#d97706' : '#64748b' }}
                          >
                          ...
                          <select
                            ...
                            style={{ flex: 1, padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.82rem', fontWeight: 700, color: '#1e40af' }}
                          >
                          ...
                          <input
                            ...
                            style={{ flex: 1, padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.82rem', fontWeight: 700, color: '#0284c7' }}
                          />
                        ) : (
                          <input
                            type="text"
                        ...
                        <button type="button" onClick={() => handleRemoveCustomField(idx)} style={{ border: 'none', background: 'none', color: '#ef4444', cursor: 'pointer', fontWeight: 'bold' }}>🗑️</button>
                      </div>
                    );
                  })}
                </div>
                ...
                <div style={{ backgroundColor: '#f8fafc', padding: '0.85rem', borderRadius: '8px', border: '1px dashed #cbd5e1', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                  <input type="text" value={newKey} onChange={(e) => setNewKey(e.target.value)} placeholder="Nuevo campo (ej. ruc, empresa)" style={{ width: '40%', padding: '0.45rem 0.65rem', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.8rem' }} />
                  <input type="text" value={newValue} onChange={(e) => setNewValue(e.target.value)} placeholder="Valor inicial..." style={{ flex: 1, padding: '0.45rem 0.65rem', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.8rem' }} />
                  <button type="button" onClick={handleAddCustomField} style={{ padding: '0.45rem 0.85rem', borderRadius: '6px', border: 'none', backgroundColor: '#10b981', color: '#ffffff', fontWeight: 800, fontSize: '0.78rem', cursor: 'pointer' }}>➕ Agregar Campo</button>
                </div>
              </div>

              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem', marginTop: '1rem' }}>
                <button type="button" onClick={() => setEditingContact(null)} style={{ padding: '0.6rem 1.25rem', borderRadius: '8px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', color: '#475569', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer' }}>Cancelar</button>
                <button type="submit" disabled={savingContact} style={{ padding: '0.6rem 1.5rem', borderRadius: '8px', border: 'none', backgroundColor: '#2563eb', color: '#ffffff', fontWeight: 800, fontSize: '0.85rem', cursor: 'pointer' }}>{savingContact ? 'Guardando...' : 'Guardar Cambios ✓'}</button>
              </div>
            </form>
          </div>
        </div>
